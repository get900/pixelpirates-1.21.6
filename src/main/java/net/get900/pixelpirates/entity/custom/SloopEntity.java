...
public class SloopEntity extends BoatEntity implements GeoAnimatable {
    ...
    public SloopEntity(EntityType<? extends BoatEntity> type, World world) {
        super(type, world);
        this.setCustomName(Text.literal("Sloop"));
    }
    ...
    public void tick() {
        ...
        Vec3d sloopVelocity = this.getVelocity();
        ...
        this.getWorld().getOtherEntities(this, this.getBoundingBox().expand(0.1), entity ->
            ...
            entity.addVelocity(sloopVelocity.x * 0.9, 0, sloopVelocity.z * 0.9);
        });
    }
    ...
    // ✅ Health & sinking
    public void damageSloop(float amount) {
